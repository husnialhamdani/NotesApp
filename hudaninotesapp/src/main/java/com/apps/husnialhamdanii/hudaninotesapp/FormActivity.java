...
import com.apps.husnialhamdanii.hudaninotesapp.enitiy.NoteItem;
...
public class FormActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        if (view.getId() == R.id.btn_submit) {
            ...
            if (!isEmptyField) {
                ...
                if (isUpdate) {
                    ...
                    Toast.makeText(this, "Note succefully updated", Toast.LENGTH_SHORT).show();
                } else {
                    getContentResolver().insert(CONTENT_URI, mContentValues);
                    Toast.makeText(this, "Note has been adde", Toast.LENGTH_SHORT).show();
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_delere){
