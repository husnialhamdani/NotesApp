...
import static com.apps.husnialhamdanii.mynotesapp.db.DatabaseContract.NoteColumns.DATE;
import static com.apps.husnialhamdanii.mynotesapp.db.DatabaseContract.NoteColumns.DESCRIPTION;
import static com.apps.husnialhamdanii.mynotesapp.db.DatabaseContract.NoteColumns.TITLE;
...
public class FormAddUpdateActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_submit) {
            ...
            if (TextUtils.isEmpty(title)) {
                isEmpty = true;
                edtTitle.setError("Fiel can not be empty");
            }
            ...
            if (!isEmpty) {
                ...
                //if is Edit the setResult is Update, else setResult is ADD
                if (isEdit) {
    ...
    private void showAlertDialog(int type) {
        ...
        if (isDialogClose) {
            dialogTitle = "Cancel";
            dialogMessage = "Are you sure want to cancel the update of form ?";
        } else {
            dialogTitle = "Delete Note";
            dialogMessage = "Are you sure want to delete this note ?";
        }
